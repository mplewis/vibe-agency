# 🏗️ VIBE RESEARCH FRAMEWORK - Technical Blueprint
...
│  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐   │
│  │   MARKET_    │  │   TECH_      │  │   FACT_      │   │
│  │   RESEARCHER │  │   RESEARCHER │  │   VALIDATOR  │   │
│  └──────────────┘  └──────────────┘  └──────────────┘   │
│         │                 │                  │           │
│         └─────────────────┴──────────────────┘           │
│                           │                              │
...
│       │   │   │   ├── task_01_competitor_identification.meta.yaml
│       │   │   │   ├── task_02_pricing_analysis.md
│       │   │   │   ├── task_02_pricing_analysis.meta.yaml
│       │   │   │   ├── task_03_market_size_estimation.md
│       │   │   │   ├── task_03_market_size_estimation.meta.yaml
│       │   │   │   ├── task_04_positioning_analysis.md
│       │   │   │   ├── task_04_positioning_analysis.meta.yaml
│       │   │   │   ├── task_05_risk_identification.md
│       │   │   │   ├── task_05_risk_identification.meta.yaml
│       │   │   │   ├── task_06_output_generation.md
│       │   │   │   └── task_06_output_generation.meta.yaml
│       │   │   └── gates/
│       │   │       ├── gate_all_competitors_cited.md
│       │   │       ├── gate_pricing_data_verifiable.md
│       │   │       └── gate_market_size_has_source.md
│       │   │
│       │   ├── TECH_RESEARCHER/
│       │   │   ├── _composition.yaml
│       │   │   ├── _knowledge_deps.yaml
│       │   │   ├── _prompt_core.md
│       │   │   ├── tasks/
│       │   │   │   ├── task_01_api_evaluation.md
│       │   │   │   ├── task_01_api_evaluation.meta.yaml
│       │   │   │   ├── task_02_library_comparison.md
│       │   │   │   ├── task_02_library_comparison.meta.yaml
│       │   │   │   ├── task_03_stack_recommendation.md
│       │   │   │   ├── task_03_stack_recommendation.meta.yaml
│       │   │   │   ├── task_04_constraint_identification.md
│       │   │   │   ├── task_04_constraint_identification.meta.yaml
│       │   │   │   ├── task_05_feasibility_validation.md
│       │   │   │   ├── task_05_feasibility_validation.meta.yaml
│       │   │   │   ├── task_06_output_generation.md
│       │   │   │   └── task_06_output_generation.meta.yaml
│       │   │   └── gates/
│       │   │       ├── gate_all_apis_have_docs.md
│       │   │       ├── gate_fae_violations_cited.md
│       │   │       └── gate_library_maintenance_checked.md
│       │   │
│       │   ├── FACT_VALIDATOR/
│       │   │   ├── _composition.yaml
│       │   │   ├── _knowledge_deps.yaml
│       │   │   ├── _prompt_core.md
│       │   │   ├── tasks/
│       │   │   │   ├── task_01_knowledge_base_audit.md
│       │   │   │   ├── task_01_knowledge_base_audit.meta.yaml
│       │   │   │   ├── task_02_claim_verification.md
│       │   │   │   ├── task_02_claim_verification.meta.yaml
│       │   │   │   ├── task_03_red_flag_detection.md
│       │   │   │   ├── task_03_red_flag_detection.meta.yaml
│       │   │   │   ├── task_04_citation_enforcement.md
│       │   │   │   ├── task_04_citation_enforcement.meta.yaml
│       │   │   │   ├── task_05_correction_recommendations.md
│       │   │   │   ├── task_05_correction_recommendations.meta.yaml
│       │   │   │   ├── task_06_output_generation.md
│       │   │   │   └── task_06_output_generation.meta.yaml
│       │   │   └── gates/
│       │   │       ├── gate_all_claims_verified_or_flagged.md
│       │   │       ├── gate_citation_index_complete.md
│       │   │       └── gate_no_critical_hallucinations.md
│       │   │
│       │   └── USER_RESEARCHER/
│       │       ├── _composition.yaml
│       │       ├── _knowledge_deps.yaml
│       │       ├── _prompt_core.md
│       │       ├── tasks/
│       │       │   ├── task_01_persona_generation.md
│       │       │   ├── task_01_persona_generation.meta.yaml
│       │       │   ├── task_02_pain_point_identification.md
│       │       │   ├── task_02_pain_point_identification.meta.yaml
│       │       │   ├── task_03_interview_script_creation.md
│       │       │   ├── task_03_interview_script_creation.meta.yaml
│       │       │   ├── task_04_survey_design.md
│       │       │   ├── task_04_survey_design.meta.yaml
│       │       │   ├── task_05_user_journey_mapping.md
│       │       │   ├── task_05_user_journey_mapping.meta.yaml
│       │       │   ├── task_06_output_generation.md
│       │       │   └── task_06_output_generation.meta.yaml
│       │       └── gates/
│       │           ├── gate_personas_industry_standard.md
│       │           └── gate_interview_questions_actionable.md
│       │
│       ├── knowledge/
...
│           (adds: RESEARCH sub-state)
│
└── agency_os/01_planning_framework/
    └── agents/
        └── LEAN_CANVAS_VALIDATOR/
            ├── _prompt_core.md                       # UPDATED
            └── tasks/
                └── task_01_canvas_interview.md       # UPDATED
...
formulas:
  - name: "TAM_calculation"
    ...
    example: "100M freelancers × $120/year = $12B TAM"
  ...
  - name: "SAM_calculation"
    ...
    formula: "TAM × percentage in your segment"
    example: "$12B TAM × 5% (designers only) = $600M SAM"
    source: "https://www.svb.com/startup-insights/market-research/tam-sam-som"

  - name: "SOM_calculation"
    full_name: "Serviceable Obtainable Market"
    formula: "SAM × realistic market share (1-5% for startups)"
    example: "$600M SAM × 2% = $12M SOM (Year 1 target)"
    source: "https://www.svb.com/startup-insights/market-research/tam-sam-som"
...
orchestration_rules:
  - rule: "research_optionality"
    ...
    actions:
      - if_yes: "Run RESEARCH → BUSINESS_VALIDATION → FEATURE_SPECIFICATION"
      - if_no: "Skip to BUSINESS_VALIDATION → FEATURE_SPECIFICATION"
...
```python
"""
Test suite for RESEARCH → BUSINESS_VALIDATION integration
"""
