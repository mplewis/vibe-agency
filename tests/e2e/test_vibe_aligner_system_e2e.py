...
class TestVibeAlignerSystemE2E:
    ...
    def mock_llm_responses(self):
        ...
        task_03_response = {
            ...
            "fae_validation": {
                ...
                "F002": {"status": "FEASIBLE", "constraints": ["Payment gateway integration required"]},
                "F003": {"status": "FEASIBLE", "constraints": ["Twilio/SendGrid API required"]}
            },
            "metadata": {
                "task": "feasibility_validation",
                "fae_rules_applied": 15
            }
        }
        ...
        task_05_response = {
            ...
            "total_complexity": 42,
            "metadata": {
                "task": "scope_negotiation",
                "apce_rules_applied": 12
            }
        }
    ...
    def test_vibe_aligner_full_system_flow(
        ...
        with patch('core_orchestrator.LLMClient') as MockLLMClient:
            ...
            assert 'scope_negotiation' in feature_spec, "feature_spec should have 'scope_negotiation' section"
            ...
            assert guardian_found_count > 0, "Guardian Directives should be present in at least one prompt"
            print(f"✓ Guardian Directives found in {guardian_found_count}/{len(executed_prompts)} prompts")
            ...
            assert 'errors' not in updated_manifest.get('status', {}), "Manifest should not have errors"
