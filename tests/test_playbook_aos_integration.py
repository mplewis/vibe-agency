...
def test_context_loader():
    ...
    assert context['session']['phase'] in ['PLANNING', 'CODING', 'TESTING', 'DEPLOYMENT', 'MAINTENANCE']
...
def test_prompt_composer():
    ...
    context = {
        ...
        'git': {'branch': 'main', 'uncommitted': 2, 'last_commit': 'abc123', 'recent_commits': ['abc123 Fix bug']},
