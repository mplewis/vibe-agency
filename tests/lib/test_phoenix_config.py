...
from phoenix_config import (
    UniversalConfig, DatabaseConfig, APIConfig, 
    LoggingConfig, ConfigurationError
)
...
class TestUniversalConfig:
    ...
    def test_testing_config_with_overrides(self):
        ...
        config = UniversalConfig.create_for_testing(
            database=DatabaseConfig(url="postgresql://test"),
    ...
    def test_get_database_url(self):
        ...
        config = UniversalConfig(
            database=DatabaseConfig(url="postgresql://${USER}@localhost/db")
        )
