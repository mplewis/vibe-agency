...
**Integration Points:**
- `agency_os/core_system/runtime/llm_client.py:289` - Pre-flight check
- `agency_os/core_system/runtime/llm_client.py:323` - Post-flight recording
...
```bash
# Read implementation
cat agency_os/core_system/runtime/quota_manager.py

# Check integration
grep -n "quota_manager" agency_os/core_system/runtime/llm_client.py
...
```python
from agency_os.core_system.runtime.quota_manager import OperationalQuota
...
```python
from agency_os.core_system.runtime.quota_manager import OperationalQuota, QuotaLimits
